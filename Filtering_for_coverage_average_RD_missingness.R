...
vcf_S4 <- read.vcfR("/path/to/your/own/working/directory/YOUR_DATA.vcf", verbose = FALSE)

setwd("/path/to/your/own/working/directory/final_data_analysis_paper/")
...
#### Write new file ------------------------------------------------------------
write.vcf(vcf_S4, file="GB10_YOUR_DATA_after_filtering.vcf.gz", mask=FALSE)
rm(dp,gt)
