...
### Calculate Fst value between the different populations
...
# allele frequency difference between the subpopulations selected
# in opposite directions. This  adjustment can be used to identify
# truly selected sites.
